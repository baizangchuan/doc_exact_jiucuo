...
def main():
    ...
    input_json_dir="/data1/hhj/project/demo/template/Case_info/input.json"
    format_guide_json="/data1/hhj/project/demo/template/Case_info/output_example.json"#格式参考文件的路径
    ...
    #保存
    with open("/data1/hhj/project/demo/template/Case_info/final_data_py.json", 'w') as json_file:
