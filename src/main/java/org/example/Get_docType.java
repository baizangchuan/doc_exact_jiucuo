...
public class Get_docType {
    ...
    public static ArrayList<String> Get_DocTypeList() {
        ...
        try {
            ...
            String sql = "select * from hp_config_node";
...
//     public static String Get_DocType(String Content, ArrayList<HashMap<String, Object>> database_doctype_list) {
...
//     }
    public static String extractSubstring(String input) {
        ...
        if (length <= 120) {
            // 如果字符串长度小于或等于60，直接返回原字符串
            return input;
        } else {
            // 截取前30个字符
            String firstPart = input.substring(0, 60);
            // 截取后30个字符，注意这里要减去1，因为substring的第二个参数是截取到指定位置的前一个字符
            String lastPart = input.substring(length - 60);
    ...
    // public static ArrayList<HashMap<String, Object>> GetDataFromDatabase() {
    ...
    //         String sql = "select * from new_template";
    ...
    public static ArrayList<HashMap<String, Object>> GetDataFromDatabase_2() {
        ArrayList<HashMap<String, Object>> databaseDoctypeList = new ArrayList<>();
        ...
        HashMap<String, Object> admitInfo = new HashMap<>();
        HashMap<String, Object> caseInfo = new HashMap<>();
        HashMap<String, Object> dischargeInfo = new HashMap<>();
        HashMap<String, Object> firstCaseInfo = new HashMap<>();
        HashMap<String, Object> informInfo = new HashMap<>();
        HashMap<String, Object> operationInfo = new HashMap<>();
        HashMap<String, Object> postoperativeFirstCaseInfo = new HashMap<>();
        HashMap<String, Object> deathInfo = new HashMap<>();
        HashMap<String, Object> newTemplateInfo = new HashMap<>();
        ArrayList<String> admitTypes = new ArrayList<>();
        ArrayList<String> caseTypes = new ArrayList<>();
        ArrayList<String> dischargeTypes = new ArrayList<>();
        ArrayList<String> firstCaseTypes = new ArrayList<>();
        ArrayList<String> informTypes = new ArrayList<>();
        ArrayList<String> operationTypes = new ArrayList<>();
        ArrayList<String> postoperativeFirstCaseTypes = new ArrayList<>();
        ArrayList<String> deathTypes = new ArrayList<>();
        ArrayList<String> newTemplateTypes = new ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (isType.equals("type")) {
                    ...
                    if (schema.equals("admit_info")) {
                        admitInfo.put("doc_type", "admit_info");
                        String type = rs.getString("config_node_key");
                        admitTypes.add(type);
                        admitInfo.put("type", admitTypes);
                    }
                    if (schema.equals("case_info")) {
                        caseInfo.put("doc_type", "case_info");
                        String type = rs.getString("config_node_key");
                        caseTypes.add(type);
                        caseInfo.put("type", caseTypes);
                    }
                    if (schema.equals("discharge_info")) {
                        dischargeInfo.put("doc_type", "discharge_info");
                        String type = rs.getString("config_node_key");
                        dischargeTypes.add(type);
                        dischargeInfo.put("type", dischargeTypes);
                    }
                    if (schema.equals("first_case_info")) {
                        firstCaseInfo.put("doc_type", "first_case_info");
                        String type = rs.getString("config_node_key");
                        firstCaseTypes.add(type);
                        firstCaseInfo.put("type", firstCaseTypes);
                    }
                    if (schema.equals("inform_info")) {
                        informInfo.put("doc_type", "inform_info");
                        String type = rs.getString("config_node_key");
                        informTypes.add(type);
                        informInfo.put("type", informTypes);
                    }
                    if (schema.equals("operation_info")) {
                        operationInfo.put("doc_type", "operation_info");
                        String type = rs.getString("config_node_key");
                        operationTypes.add(type);
                        operationInfo.put("type", operationTypes);
                    }
                    if (schema.equals("postoperative_first_case_info")) {
                        postoperativeFirstCaseInfo.put("doc_type", "postoperative_first_case_info");
                        String type = rs.getString("config_node_key");
                        postoperativeFirstCaseTypes.add(type);
                        postoperativeFirstCaseInfo.put("type", postoperativeFirstCaseTypes);
                    }
                    if (schema.equals("death_info")) {
                        deathInfo.put("doc_type", "death_info");
                        String type = rs.getString("config_node_key");
                        deathTypes.add(type);
                        deathInfo.put("type", deathTypes);
                    }
                    if (schema.equals("new_template")) {
                        newTemplateInfo.put("doc_type", "new_template");
                        String type = rs.getString("config_node_key");
                        newTemplateTypes.add(type);
                        newTemplateInfo.put("type", newTemplateTypes);
                    }
            ...
            databaseDoctypeList.add(admitInfo);
            databaseDoctypeList.add(caseInfo);
            databaseDoctypeList.add(dischargeInfo);
            databaseDoctypeList.add(informInfo);
            databaseDoctypeList.add(firstCaseInfo);
            databaseDoctypeList.add(postoperativeFirstCaseInfo);
            databaseDoctypeList.add(operationInfo);
//            databaseDoctypeList.add(deathInfo);
//            databaseDoctypeList.add(newTemplateInfo);
        }catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // String doc_type = Get_DocType(json_content, database_doctype_list);
